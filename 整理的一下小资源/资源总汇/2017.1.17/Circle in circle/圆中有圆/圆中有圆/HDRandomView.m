...
//    [_randomCicleView removeAllObjects];
    if (_hdDataSource &&
        ...
        NSMutableArray *randomCircleInfos = [self generateRandomView:randomViewCount]; //生成定制的 标准圆
