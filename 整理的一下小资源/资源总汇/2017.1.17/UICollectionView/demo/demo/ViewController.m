...
//        [datas writeToFile:@"/Users/zhong/Desktop/TTT/items.plist" atomically:YES];
        [datas writeToFile:@"/Users/jczj/Desktop/JJJ/items.plist" atomically:YES];
...
- (void)setupCollectionView {
    ...
    layout.minimumLineSpacing = 0; //设置行与行之间的间距最小距离
    layout.minimumInteritemSpacing = 0; //设置列与列之间的间距最小距离
