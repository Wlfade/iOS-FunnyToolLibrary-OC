...
- (void)_setUI{
    UIColor *customColor = [UIColor colorWithRed:arc4random_uniform(255)/255.0 green:arc4random_uniform(255)/255.0 blue:arc4random_uniform(255)/255.0 alpha:1];
    _btn = [UIButton buttonWithType:UIButtonTypeCustom];
    _btn.frame = CGRectMake(50, SCREEN_WIDTH * 0.7, 100, 30);
...
- (void)groupAnimation{
    ...
    CABasicAnimation *narrowAniamtion = [CABasicAnimation animationWithKeyPath:@"transform.scale"];
    narrowAniamtion.beginTime = 0.5;
    narrowAniamtion.fromValue = [NSNumber numberWithFloat:2.0f];
    narrowAniamtion.toValue = [NSNumber numberWithFloat:0.5f];
    
    narrowAniamtion.timingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionEaseOut];
    
    CAAnimationGroup *groups = [CAAnimationGroup animation];
    groups.animations = @[animation,expandAnimation,narrowAniamtion];
