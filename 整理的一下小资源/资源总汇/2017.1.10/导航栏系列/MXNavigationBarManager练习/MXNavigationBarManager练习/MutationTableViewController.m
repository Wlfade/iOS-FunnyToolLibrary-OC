...
- (void)initBarManager {
    ...
    //渐变设置 为YES  突变设置 为NO  默认为YES
    [MXNavigationBarManager setContinues:NO];
}
- (void)initBaseData {
    self.title = @"长草颜文字";
    
    [self.tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:kBackCellIdentifer];
    ...
    UIBarButtonItem *barButtonItem = [[UIBarButtonItem alloc]initWithTitle:@"Mutain" style:UIBarButtonItemStylePlain target:self action:@selector(mutation)];
