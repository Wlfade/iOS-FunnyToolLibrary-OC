...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let thread01 = Thread.init(target: self, selector:#selector(ViewController.saleTickect), object: nil)
        let thread02 = Thread.init(target: self, selector: #selector(ViewController.saleTickect), object: nil);
        let thread03 = Thread.init(target: self, selector: #selector(ViewController.saleTickect), object: nil);
