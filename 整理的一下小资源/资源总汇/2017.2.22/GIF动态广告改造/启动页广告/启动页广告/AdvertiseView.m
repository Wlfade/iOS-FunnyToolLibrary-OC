...
//        _adView.clipsToBounds = YES;
        _animatedImageView = [[FLAnimatedImageView alloc]initWithFrame:frame];
        _animatedImageView.backgroundColor = [UIColor redColor];
...
//        _animatedImageView.animatedImage = [self animatedImageWithURLForResource:@"GuidePage1"];
        
        UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(pushToAd)];
//        [_adView addGestureRecognizer:tap];
        [_animatedImageView addGestureRecognizer:tap];
